...
sc3_f1 = open('scenarios/Static/Task_1_Jun-08-21.log')
sc3_f2 = open('scenarios/Static/Task_2_Jun-08-21.log')
sc3_f3 = open('scenarios/Static/Task_3_Jun-08-21.log')
sc3_f4 = open('scenarios/Static/Task_4_Jun-08-21.log')
...
sc3_filename1 = os.path.basename('scenarios/Static/Task_1_Jun-08-21.log')
sc3_filename2 = os.path.basename('scenarios/Static/Task_2_Jun-08-21.log')
sc3_filename3 = os.path.basename('scenarios/Static/Task_3_Jun-08-21.log')
sc3_filename4 = os.path.basename('scenarios/Static/Task_4_Jun-08-21.log')
...
sc3_g1 = buildgraph(sc3_f1, view)
sc3_g2 = buildgraph(sc3_f2, view)
sc3_g3 = buildgraph(sc3_f3, view)
sc3_g4 = buildgraph(sc3_f4, view)

sc1_graphs = [sc1_g1,sc1_g2,sc1_g3,sc1_g4,sc2_g1,sc2_g2,sc2_g3,sc2_g4,sc3_g1,sc3_g2,sc3_g3,sc3_g4]
sc2_graphs = sc1_graphs
